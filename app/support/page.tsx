    ...
    <div className="mx-auto max-w-4xl px-4 py-12 space-y-16">
      ...
      <section className="space-y-6 text-center">
        ...
        <div className="space-y-4 max-w-2xl mx-auto">
          <p className="text-lg text-muted-foreground leading-relaxed">
            Your contribution directly supports servers, image hosting, site
            assets, and ongoing development. Core features remain available to
            everyone.
          </p>
          <p className="text-sm text-muted-foreground">
            Current stage of this page is still WIP, tiers perks and goals can
      ...
      <section className="space-y-6">
        ...
        <Alert>
          ...
          <AlertDescription>
            Monthly plans will return later. You can still support via Patreon
            or GitHub Sponsors pages, but benefits won&apos;t sync until monthly
            is re-enabled here.
          </AlertDescription>
        </Alert>
      ...
      <section className="space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Pick a custom amount or use a quick amount. Rewards unlock when a
            single transaction meets a tier minimum.
          </p>
        </div>

        <div className="space-y-6 bg-muted/30 rounded-2xl p-8 border">
          <div className="space-y-4">
              ...
              matchedTier ? (
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-muted-foreground">
                    ...
                    <span className="font-medium">${matchedTier.minUSD}+</span>{" "}
                    {matchedTier.name}.
                  </span>
                </div>
              ) : (
                <span className="text-muted-foreground">
                  Contribute <span className="font-medium">$2+</span> to unlock
                  the <span className="font-medium">Donor</span> tier.
                </span>
              )
            ) : (
              <span className="text-muted-foreground">
                Select an amount to see your tier.
              </span>
            )}
          </div>
          ...
          <div className="space-y-4">
            <div className="flex flex-wrap gap-3">
              <Button
                ...
                disabled={usd < 2 || isProcessingStripe}
            ...
            <p className="text-xs text-muted-foreground">
              Stripe provides secure card payments. Other providers redirect to
      ...
      <section className="space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Cosmetic and quality-of-life rewards designed for a social media
            app. See FAQ for duration and details.
          </p>
        </div>
        ...
        {/* Bonus rule */}
        <div className="bg-muted/30 rounded-2xl p-6 space-y-2 border">
          <h4 className="font-semibold">Bonus Rename Credits</h4>
          <p className="text-sm text-muted-foreground leading-relaxed">
            Every <span className="font-medium">$2</span> in a single
            transaction grants{" "}
            <span className="font-medium">+1 username change</span> (max 12
            stored). Manage in{" "}
      ...
      <section className="space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground leading-relaxed">
            These communicate what funded work we can deliver. We&apos;ll keep
            you updated as goals are reached and items ship.
          </p>
        </div>
          ...
          <div className="bg-primary/5 rounded-2xl p-6 border border-primary/20">
            <div className="flex items-center gap-3 mb-4">
              ...
              <Badge className="text-sm">
                ${STRETCH.amountUSD.toLocaleString()}
              </Badge>
            </div>
            <ul className="space-y-3 text-sm">
        ...
        <Accordion type="single" collapsible className="space-y-3">
          <AccordionItem value="rewards" className="border rounded-xl px-6">
            ...
            <AccordionContent className="text-sm text-muted-foreground leading-relaxed">
              Rewards apply once your transaction is verified (typically within
              24h). Discord roles are assigned after you link your account or DM
              proof on the server.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="duration" className="border rounded-xl px-6">
            ...
            <AccordionContent className="text-sm text-muted-foreground leading-relaxed">
              One-time tier rewards are persistent unless marked time-limited.
              Monthly rewards resume when monthly plans return and your status
              is synced.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem
          ...
          >
            <AccordionTrigger className="text-sm font-medium">
              Can I pay in small amounts over time?
            </AccordionTrigger>
            <AccordionContent className="text-sm text-muted-foreground leading-relaxed">
              Yes, but tier unlocks are based on the amount in a single
              transaction. Bonus rename credits also count per single
              transaction.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="featured" className="border rounded-xl px-6">
            <AccordionTrigger className="text-sm font-medium">
              Who is featured on the front page?
            </AccordionTrigger>
            <AccordionContent className="text-sm text-muted-foreground leading-relaxed">
              Supporter+ and above are eligible for &quot;Featured
              Supporters&quot; (opt-in). Rotation keeps it fair and fresh.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="cancel" className="border rounded-xl px-6">
            ...
            <AccordionContent className="text-sm text-muted-foreground leading-relaxed">
              Cancel on the platform you used (Patreon or GitHub Sponsors).
              We&apos;ll re-sync statuses automatically once monthly returns.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </section>
      ...
      {/* Terms */}
      <section className="bg-muted/30 rounded-2xl p-6 space-y-3 border">
        <h3 className="font-semibold">Terms &amp; Conditions</h3>
        <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-2 leading-relaxed">
          <li>
            If you have an issue with payment or rewards, please contact{" "}
            <span className="font-medium">@admin</span>.
          </li>
          <li>
            All contributors must follow the rules and ToS. Administrative
            actions don&apos;t qualify for refunds or benefit extensions.
          </li>
          <li>
            * Banner artwork must meet content guidelines; staff may request a
            different image if necessary.
          </li>
        </ul>
      </section>
    </div>
...
function ProviderButton({
  ...
  return (
    <Button asChild variant={variant} className="h-10 min-w-24">
      <Link
    ...
    >
      <div className="space-y-4">
        ...
        <div className="text-sm text-muted-foreground">
          <span className="font-semibold">${tier.minUSD}+</span> •{" "}
          {tier.tagline}
        </div>
