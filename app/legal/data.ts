...
export const PRIVACY_CONTENT: Array<{
...
}> = [
	{
		...
		blocks: [
			{
				type: "p",
				text: "This Privacy Policy explains how **{SITE}** (“we”, “us”, “our”) collects, uses, and protects your personal information when you use our website and services (collectively, the “Service”). We are committed to protecting your privacy in compliance with the European Union’s General Data Protection Regulation (GDPR) and other applicable privacy laws.",
			},
			{ type: "p", text: "" },
			{
				type: "p",
				text: "By using {SITE}, you agree to the collection and use of information in accordance with this Privacy Policy. If you do not agree, please refrain from using the Service.",
			},
		],
	},
	{
		...
		blocks: [
			...
			},
			{
				...
				items: [
					...
					{
						text: "Usage Data & Technical Information: When you use RabbitHole, our systems automatically record some technical information, such as:",
						items: [
	...
	},
	{
		...
		blocks: [
			{
				type: "p",
				text: "{SITE} uses some automated processes to provide and secure the service, but **we do not use automated decision-making that produces legal effects or similarly significant effects on you without human involvement** (as per GDPR Art. 22).",
			},
			{
				type: "ul",
				items: [
...
export const TERMS_CONTENT: Array<{
		...
		blocks: [
			{
				...
				items: [
					...
					{
						text: "Your Responsibilities for Content: You warrant that you have all necessary rights to the Content you upload. This means:",
						items: [
	...
	},
	{
		...
		blocks: [
			{
				type: "p",
				text: "We act as a **hosting service provider** under the EU Digital Services Act (Regulation (EU) 2022/2065). This means we generally do not actively monitor all user content, but we have mechanisms to address illegal content or Terms violations once we become aware. Our moderation approach includes:",
			},
			{
				type: "ul",
				items: [
		...
		blocks: [
			{
				...
				items: [
					...
					{
						text: "Takedown Requests (Copyright/IP): If you believe that content on our Service infringes your copyright or other intellectual property rights, please send a detailed notice to [CONTACT_EMAIL](mailto:{CONTACT_EMAIL}). Your notice should include:",
						items: [
	...
	},
	{
		...
		blocks: [
			{
				type: "p",
				text: "Your use of {SITE} is also governed by our [Privacy Policy](/legal/privacy), which outlines how we collect, use, and protect your personal data. We adhere to the EU General Data Protection Regulation (GDPR) as our company is based in Poland. Some key points:",
			},
			{
				type: "ul",
				items: [
	...
	},
	{
		...
		blocks: [
			{
				type: "p",
				text: "{SITE} may offer an optional **premium subscription** (provisionally called “**Golden Carrot**” or similar) which provides additional features or benefits for a fee. We provide the following consumer information in compliance with EU laws (e.g., Consumer Rights Directive):",
			},
			{
				type: "ul",
				items: [
			...
			{
				type: "p",
				text: "(*This section is provided to ensure compliance with EU consumer protection laws. It gives you transparent information about any paid services, fulfilling requirements such as those in the Consumer Rights Directive.*)",
			},
		],
	},
	{
		...
		blocks: [
			{
				type: "p",
				text: "All payments for {SITE} services (including subscriptions like Golden Carrot, and any future features like tipping or commissions) are processed by third-party payment providers (such as **Stripe, Inc**. or its affiliates). We do not collect or store your full credit card details on our servers.",
			},
			{
				type: "ul",
				items: [
	...
	},
	{
		...
		blocks: [
			{
				type: "p",
				text: "{SITE} integrates with various third-party services to provide a richer experience. By using RabbitHole, you acknowledge and agree that:",
			},
			{
				type: "ul",
				items: [
	...
	},
	{
		...
		blocks: [
			{
				type: "p",
				text: "**“As-Is” Service:** {SITE} is provided to you on an “**as is**” and “**as available**” basis. While we strive to provide a great service, we **do not guarantee** that the Service will meet all your expectations or requirements, or that it will be uninterrupted, secure, or error-free at all times",
			},
			{
				type: "ul",
				items: [
		...
		blocks: [
			{
				...
				items: [
					...
					{
						text: "Your Indemnification to Us: You agree to indemnify and hold harmless {COMPANY} and its affiliates, officers, employees, and agents from any losses, liabilities, claims, demands, damages, expenses, or costs (including reasonable attorney’s fees) arising out of or related to:",
						items: [
	...
	},
	{
		...
		blocks: [
			{
				type: "p",
				text: "If you have any questions, concerns, or feedback about these Terms or the Service, you can reach out to us:",
			},
			{
				type: "ul",
				items: [
			...
			{
				type: "p",
				text: "We typically respond to user inquiries within a few business days. For any legal notices or service of process, please send them to our registered address with a copy via email if possible.",
			},
		],
	},
];
