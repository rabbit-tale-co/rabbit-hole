...
import { OutlineArrowRight, SolidLogo } from "@/components/icons/Icons";
...
export default function Footer() {
	...
	const resourceLinks = [
		...
		{
			label: "Source Code",
			href: "https://github.com/rabbit-tale-co/rabbit-hole",
		},
	];
	...
	return (
		<footer
			...
			style={{
				paddingBottom:
					"calc(var(--mobile-bottom-nav-height, 0px) + env(safe-area-inset-bottom, 0px))",
			}}
		>
			<div className="">
				{/* Main Footer Content */}
