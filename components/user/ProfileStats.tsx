...
export function ProfileStats({
  ...
  useEffect(() => {
    console.log('ProfileStats stats changed:', { posts, views, following, followers }, 'hasAnimated:', hasAnimatedRef.current);
  ...
  return (
    <>
      <div ref={containerRef} className="flex justify-center h-8 items-center space-x-1 tabular-nums">
        <Button
          variant="ghost"
          size="sm"
          className="font-mono"
