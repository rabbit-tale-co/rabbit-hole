  ...
  `,
  {
    variants: {
      variant: {
        ...
        md: "h-10 px-3 text-[0.8125rem] leading-(--text-sm--line-height) rounded-full file:pe-3 file:me-3",
        sm: "h-9 px-2.5 text-xs rounded-full file:pe-2.5 file:me-2.5",
      },
    },
    defaultVariants: {
      variant: "md",
...
const inputAddonVariants = cva(
  "flex items-center shrink-0 justify-center bg-muted border border-input shadow-xs shadow-[rgba(0,0,0,0.05)] text-secondary-foreground [&_svg]:text-secondary-foreground/60",
  {
    variants: {
      variant: {
        sm: "rounded-full h-9 min-w-9 text-xs px-2.5 [&_svg:not([class*=size-])]:size-3.5",
        md: "rounded-full h-10 min-w-10 px-3 text-[0.8125rem] leading-(--text-sm--line-height) [&_svg:not([class*=size-])]:size-4.5",
        lg: "rounded-full h-12 min-w-12 px-4 text-sm [&_svg:not([class*=size-])]:size-4.5",
      },
      mode: {
        default: "",
...
const inputWrapperVariants = cva(
  ...
  `,
  {
    variants: {
      variant: {
        sm: "gap-1.5 [&_svg:not([class*=size-])]:size-4",
