...
function MediaPlayerRootImpl(props: MediaPlayerRootProps) {
	...
	}, [onControlsShow, autoHide, menuOpen, mediaPaused, dragging, store]);
...
type MediaPlayerLoadingProps = React.ComponentProps<"div"> & {
	delayMs?: number;
	asChild?: boolean;
};

function MediaPlayerLoading(props: MediaPlayerLoadingProps) {
	const { delayMs = 500, asChild, className, ...loadingProps } = props;
