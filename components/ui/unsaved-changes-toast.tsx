...
export function UnsavedChangesToast({
	...
	const toastContent = (
		<div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 flex items-center justify-between w-full p-1 pl-3 h-12 bg-white rounded-2xl shadow-lg border min-w-[32rem] max-w-4xl z-[999999]">
