import type { PlacedTile, Tile } from "./bento";
import type { PostRow, UUID } from "./db";

export type UseReactionsArgs = {
	postId: UUID;
	userId: UUID;
	init?: Partial<{ liked: boolean; bookmarked: boolean; reposted: boolean }>;
};
